...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/sudiptamall/MathUtilityLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sudiptamall' => 'sudipta.mall@comviva.com' }
  s.source           = { :git => 'https://github.com/sudiptamall/MathUtilityLib.git', :tag => s.version.to_s }
